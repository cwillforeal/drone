/** @file ble.c
 * 
 * @brief This modules handles the ble connection
 */
#include "ble.h"
#include "btstack.h"
...
/**
 * @brief Sets up the ble interface to send data
 * 
...
/**
 * @brief Starts up the ble interface
 */
void ble_start(void)
{
...
/** @brief handles packets comming in over the BLE interface
 * 
 */
static void packet_handler(uint8_t packet_type, uint16_t channel, uint8_t *packet, uint16_t size) 
{
...
/** @brief Callback function for reading an attribute
 * 
 */
static uint16_t att_read_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t offset, uint8_t * buffer, uint16_t buffer_size) 
{
...
/** @brief Callback function for when an attribute is written to.
 * 
 */
static int att_write_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t transaction_mode, uint16_t offset, uint8_t *buffer, uint16_t buffer_size) 
{
